    ...
    <button onClick={avail ? onClick : undefined}
      ...
      {coverUrl && !imgErr
        ? <img
            ...
            className="w-12 h-16 object-cover rounded-lg flex-shrink-0 bg-green-50"
          />
        : <div className="w-12 h-16 bg-green-100 rounded-lg flex items-center justify-center flex-shrink-0 text-xl">
            📚
          </div>
      }
