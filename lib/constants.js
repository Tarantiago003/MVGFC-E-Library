...
export const COL = {
  ...
  // Analytics sheet: ID | UserID | UserName | Institute | ResourceName | ResourceURL | Timestamp
  ANALYTICS: {
    ID:0, USER_ID:1, USER_NAME:2, INSTITUTE:3, RESOURCE_NAME:4, RESOURCE_URL:5, TIMESTAMP:6
  }
}
