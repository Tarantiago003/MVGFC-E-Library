...
export const NOTIF_TYPE = {
  ...
  BORROW_RENEWED:   'BORROW_RENEWED',   // NEW — renewal request notification
...
// NOTE: Books col 0 = "Assc. No." (displayed as Accession Number, not "BookID")
// NOTE: Books col 3 renamed from ISBN → YEAR (publication year); update your Sheet header too
export const COL = {
  USERS: {
  ...
  BOOKS: {
    // Col 0 label in Sheet: "Assc. No."  |  Col 3 label in Sheet: "Year"
