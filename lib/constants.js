...
export const NOTIF_TYPE = {
  ...
  BORROW_RENEWED:   'BORROW_RENEWED',
  CHAT_REPLY:       'CHAT_REPLY',
  ACCOUNT_STATUS:   'ACCOUNT_STATUS'
}

export const INSTITUTES = ['INAJS', 'ICJE', 'IICT', 'IBM', 'CPTE']
...
export const SHEETS = {
  ...
  ANALYTICS:     'Analytics'       // NEW — add this tab in Google Sheets
}
...
export const COL = {
  USERS: {
    ...
    PASSWORD:17, INSTITUTE:18          // NEW — append column S in sheet
  },
  BOOKS: {
    ID:0, TITLE:1, AUTHOR:2, YEAR:3, CATEGORY:4, LOCATION:5,
  ...
  // Analytics sheet: ID | UserID | UserName | SchoolID | Institute | ResourceName | ResourceURL | Timestamp
  ANALYTICS: {
    ID:0, USER_ID:1, USER_NAME:2, SCHOOL_ID:3, INSTITUTE:4, RESOURCE_NAME:5, RESOURCE_URL:6, TIMESTAMP:7
  }
}
